<%@ Page Title="" Language="C#" MasterPageFile="~/Main_master.Master" AutoEventWireup="true" CodeBehind="HDeleteRecreq.aspx.cs" Inherits="Group4.HDeleteRecreq" %>
        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox well col-md-9 col-md-offset-3">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div style="font-size: x-large; font-weight: normal; font-style: normal; font-variant: normal; text-transform: none; color: #0099CC">&nbsp; Delete Recruitment Request</div>
                        ...
                        <form id="addvacancyrequestform" class="form-horizontal" role="form" runat="server">
                            ...
                            <asp:Label ID="lblSelect" Text="Select Recruitment Request ID" ForeColor="Teal" runat="server" Font-Size="Medium"></asp:Label>
                               ...
                               <asp:ListItem Value="0" Text="Select"></asp:ListItem>
                                ...
                                <asp:RequiredFieldValidator ID="rfv1" ForeColor="Red" runat="server" ErrorMessage="Select Recruitment Request ID" ControlToValidate="ddlRecID" InitialValue="0"></asp:RequiredFieldValidator>
                             ...
                             <div style="margin-top:10px" class="form-group"
                                    <!-- Button -->
                            &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="Submit" CssClass="btn-success active" runat="server" Text="View Vacancies" UseSubmitBehavior="False" BorderStyle="Solid" Width="160px" OnClick="Submit_Click" />
                                &nbsp;&nbsp;&nbsp;
                                    <br />
                            </div>
                           ...
                           <div style="margin-bottom: 10px" class="input-group">
                            ...
                            <div style="margin-bottom: 25px; text-align: center;" class="input-group">
                                     
                                   
                               
                                     
                                        
                                    <asp:Button ID="btndelete" runat="server" CssClass="btn-danger" UseSubmitBehavior="false" OnClick="btndelete_Click" Text="Delete" Width="88px" />
