<%@ Page Title="" Language="C#" MasterPageFile="~/Main_master.Master" AutoEventWireup="true" CodeBehind="HAddRecReq.aspx.cs" Inherits="Group4.HAddRecReq" %>
     ...
     <!-- Sidebar -->
        <div id="sidebar-wrapper" style="margin-top:-10px">
            <ul class="sidebar-nav">
                <li>
                    <a href="HAddRecReq.aspx">Create Recruitment Request</a></li>
        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox well col-md-9 col-md-offset-3">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div style="font-size: x-large; font-weight: normal; font-style: normal; font-variant: normal; text-transform: none; color: #0099CC">&nbsp; Create Recruitment Request</div>
                    ...
                    <div style="padding-top:20px" class="panel-body" >
                        ...
                        <form id="addvacancyrequestform" class="form-horizontal" role="form" runat="server">
                            ...
                            <div style="margin-bottom: 10px" class="input-group">
                                <asp:GridView ID="gv1" runat="server" HeaderStyle-CssClass="danger" CssClass="table table-stripe table-hover"  AlternatingRowStyle-Wrap="true" Font-Size="Small" AutoGenerateColumns="False"  Width="735px">
                                    ...
                                    <asp:TemplateField HeaderText="RequiredByDate">
                                        <ItemTemplate>
                                            <asp:Label ID="lbAge6" runat="server" Text='<%#Bind("RequiredByDate","{0:dd-MM-yyyy}")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtAge6" runat="server" Text='<%#Bind("RequiredByDate","{0:dd-MM-yyyy}")%>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <div style="margin-bottom: 10px" class="input-group">
                            <asp:Label ID="lblNoV" Text="Enter Placement consultant ID" ForeColor="Teal" runat="server" Font-Size="Medium"></asp:Label>
                               ...
                               <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                ...
                                <asp:RequiredFieldValidator ID="rfv1" runat="server" InitialValue="0" ErrorMessage="Select Placement Consultant ID." ForeColor="Red" ControlToValidate="ddlpcid"></asp:RequiredFieldValidator>
                            ...
                            <div style="margin-bottom: 25px; text-align: left;" class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div style="text-align:center;">
                                        <asp:Button ID="btnSubmit" CssClass="btn-success" runat="server" Text="Submit" UseSubmitBehavior="False" BorderStyle="Solid" Width="160px" OnClick="btnSubmit_Click" />
                                </div>
