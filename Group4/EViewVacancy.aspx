<%@ Page Title="" Language="C#" MasterPageFile="~/Main_master.Master" AutoEventWireup="true" CodeBehind="EViewVacancy.aspx.cs" Inherits="Group4.EViewVacancy" %>
                ...
                <div style="padding-top: 20px" class="panel-body">
                    ...
                    <form id="addvacancy" class="form-horizontal" role="form" runat="server">
                        ...
                        <div class="input-group">
                            <asp:GridView ID="gv1" HeaderStyle-CssClass="danger" CssClass="table table-stripe table-hover"  AlternatingRowStyle-Wrap="true" runat="server" AutoGenerateColumns="false" OnRowCancelingEdit="gv1_RowCancelingEdit" OnRowDeleting="gv1_RowDeleting" OnRowUpdating="gv1_RowUpdating" OnRowEditing="gv1_RowEditing">
