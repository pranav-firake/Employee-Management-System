<%@ Page Title="" Language="C#" MasterPageFile="~/Main_master.Master" AutoEventWireup="true" CodeBehind="EEditVacancy.aspx.cs" Inherits="Group4.EEditVacancy" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="page-top" class="index" style="height:20%">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="NoOfPositions">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvPos" runat="server" ControlToValidate="txtpositions" ForeColor="Red" ErrorMessage="Please enter a number"></asp:RequiredFieldValidator>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Experience">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:RangeValidator Type="Integer" ID="rvExp" runat="server" MaximumValue="99" MinimumValue="0" ErrorMessage="Enter a valid number" ForeColor="#ff0000" ControlToValidate="txtexp"></asp:RangeValidator>
                                            <asp:RequiredFieldValidator ID="rfvExp1" runat="server" ControlToValidate="txtexp" ErrorMessage="Enter a number"></asp:RequiredFieldValidator>
                                              </EditItemTemplate>
                                    </asp:TemplateField>
