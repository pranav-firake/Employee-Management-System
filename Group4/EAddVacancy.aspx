<%@ Page Title="" Language="C#" MasterPageFile="~/Main_master.Master" AutoEventWireup="true" CodeBehind="EAddVacancy.aspx.cs" Inherits="Group4.EAddVacancy" %>
                                         ...
                                         <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                             <ContentTemplate>
                                                 ...
                                                 <div style="margin-bottom: 25px; text-align: left;" class="input-group">
                                                     ...
                                                     <asp:RequiredFieldValidator ID="rfvExp1" runat="server" ForeColor="Red" ErrorMessage="Please enter a number" ControlToValidate="txtExperience"></asp:RequiredFieldValidator>
                                                     &nbsp;
