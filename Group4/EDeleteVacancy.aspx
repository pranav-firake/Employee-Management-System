<%@ Page Title="" Language="C#" MasterPageFile="~/Main_master.Master" AutoEventWireup="true" CodeBehind="EDeleteVacancy.aspx.cs" Inherits="Group4.EDeleteVacancy" %>
     ...
     <!-- Sidebar -->
        <div id="sidebar-wrapper" style="margin-top:-10px">
            <ul class="sidebar-nav">
               ...
               <li>
                    <a href="EAddvacancyRequest.aspx">Create Vacancy</a>
                </li>
                <li>
