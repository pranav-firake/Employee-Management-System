...
namespace Group4
{
    public partial class UAddVacancyRequest : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterStartupScript(Page.GetType(), "alertMessage", "alert('Vacancy Request added successfully');window.location='UAddVacancy.aspx';", true);
