<%@ Page Title="" Language="C#" MasterPageFile="~/Main_master.Master" AutoEventWireup="true" CodeBehind="UAddVacancyRequest.aspx.cs" Inherits="Group4.UAddVacancyRequest" %>
                    ...
                    <div style="padding-top:20px" class="panel-body" >
                        ...
                        <form id="addvacancyrequestform" class="form-horizontal" role="form" runat="server">
                            ...
                            <asp:Label ID="lblNoV" Text="Enter Number of Vacancies" ForeColor="Teal" runat="server" Font-Size="Medium"></asp:Label>
                              ...
                              &nbsp;&nbsp;
                                <asp:RangeValidator Type="Integer" ID="rvNoV" runat="server" ControlToValidate="txtNoV" ErrorMessage="Enter valid number" ForeColor="Red" MaximumValue="9999" MinimumValue="1"></asp:RangeValidator>
