<%@ Page Title="" Language="C#" MasterPageFile="~/Main_master.Master" AutoEventWireup="true" CodeBehind="UViewVacancy.aspx.cs" Inherits="Group4.UViewVacancy" %>
       ...
       <div id="loginbox" style="margin-top:50px;" class="mainbox well col-md-8 col-md-offset-3">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <div class="panel-title">View Vacancy Details</div>
                </div>
                <div style="padding-top: 20px" class="panel-body">
                    ...
                    <form id="addvacancy" class="form-horizontal" role="form" runat="server">
                        ...
                        <div class="input-group">
                            <asp:GridView ID="gv1" HeaderStyle-CssClass="danger" CssClass="table table-stripe table-hover"  AlternatingRowStyle-Wrap="true" runat="server" Font-Size="X-Small" AutoGenerateColumns="false" OnRowCancelingEdit="gv1_RowCancelingEdit" OnRowDeleting="gv1_RowDeleting" OnRowUpdating="gv1_RowUpdating" OnRowEditing="gv1_RowEditing">
